...
namespace HKIH\CPT\LandingPage;

use HKIH\CPT\LandingPage\PostTypes;

/**
 * Class LandingPagePlugin
 *
 * @package HKIH\CPT\LandingPage
 */
final class LandingPagePlugin {

    /**
     * Holds the singleton.
     *
     * @var LandingPagePlugin
     */
     ...
     */
    public static function get_instance() : LandingPagePlugin {
    ...
    protected function init_classes() {
        $this->classes['PostTypes/LandingPage'] = new PostTypes\LandingPage();
    }
    ...
    private function add_to_polylang( array $post_types ) {
        $post_types[ PostTypes\LandingPage::get_post_type() ] = PostTypes\LandingPage::get_post_type();
